...
FadePal5a:: db %10100100, %11010000, %11100000
FadePal5b:: db %10100100, %10000000, %10010000
FadePal6::  db %10010000, %10000000, %10010000
FadePal6a:: db %10010000, %10000000, %01000000
FadePal7::  db %01000000, %01000000, %01000000
FadePal7a:: db %01000000, %00000000, %00000000
FadePal8::  db %00000000, %00000000, %00000000

; -- interpolated fading pals
